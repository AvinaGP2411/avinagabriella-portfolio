...
const addressData = [
  {
    icon: faLocationDot,
    title: "Address",
    description: "Indonesia, Banten, Tangerang Selatan, 15416",
  },
  {
    icon: faEnvelope,
    title: "My Email",
    description: "avinaworkspace@gmail.com",
  },
  {
    icon: faPhone,
    title: "Whatsapp",
    description: "0812-1178-6677",
  },
];
          ...
          <div>
            <div>
              ...
              <p className="text-[12px] xs:text-[14px] sm:text-lg md:text-lg max-lg:text-center pt-4 font-normal text-soft-dark">
                I’m actively seeking opportunities in Quality Assurance, UI/UX,
                and Front-end Development. Feel free to reach out via email or
                WhatsApp to discuss a potential role, collaboration, or
                freelance project.
              </p>
            </div>
