import illustration from "../../assets/images/blog/contacts.png";
...
const commonClass =
  "input input-lg border-0 border-b-2 focus:outline-none focus:placeholder:text-pink-500 placeholder:text-[15px] md:placeholder:text-lg focus:border-pink-500 border-[#E6E8EB] w-full rounded-none px-0";
    ...
    <div>
      ...
      <div className="mx-2">
        <form className="flex flex-col gap-4 mt-4">
          ...
          <button
            type="submit"
            className="btn gap-3 max-lg:mx-auto rounded-sm mt-5 text-[13px] md:text-[16px] w-fit font-semibold lg:mt-12.5 p-2 md:px-4 bg-pink-500 hover:bg-pink-600 text-white"
          >
            Submit {telegramSVG}
          </button>
        </form>
